...
description: "Spec and build a new Claude Code plugin skill (SKILL.md plus optional supporting files) from scratch. Walks through a four-phase collaboration: study existing anatomy -> spec the skill -> confirm with user -> write and validate. Use when the user asks to build, add, or create a new Claude Code skill."
